...
class Leonardoai_Meta extends Leonardoai_Base
{
    ...
    function meal_images_meta_box($post)
    {
        ...
        <div class='inside'>
            ...
            <?php if (!empty($growtype_art_images_ids)) {

                echo '<div class="b-imgs wrap" style="gap: 10px;display: grid;">';

                foreach ($growtype_art_images_ids as $growtype_art_images_id) {
                    echo Growtype_Art_Admin_Images::preview_image($growtype_art_images_id);
                }

                echo '</div>';

                echo Growtype_Art_Admin_Images::image_delete_ajax();
