...
class Growtype_Ai_Api_Meal
{
    ...
    function register_routes()
    {
         ...
         * Get mealplan
         */
        register_rest_route('growtype-ai/v1', 'get/mealplan', array (
            'methods' => 'POST',
            'callback' => array (
                $this,
         ...
         * Meal plan
         */
//        register_rest_route('growtype-ai/v1', 'generate/mealplan/(?P<days>\d+)', array (
//            'methods' => 'POST',
//            'callback' => array (
//                $this,
...
//        ));
         ...
         * Meal plan
         */
        register_rest_route('growtype-ai/v1', 'generate/mealplan/day', array (
            'methods' => 'POST',
            'callback' => array (
                $this,
         ...
         * Generate meal
         */
        register_rest_route('growtype-ai/v1', 'generate/meal/(?P<meal_type>\w+)', array (
            'methods' => 'POST',
            'callback' => array (
                $this,
         ...
         * Get meal
         */
        register_rest_route('growtype-ai/v1', 'get/meal/(?P<meal_slug>[a-zA-Z0-9-]+)', array (
            'methods' => 'GET',
            'callback' => array (
                $this,
                'get_meal_callback'
...
//        $meal_plan[0]['meals'] = Generate_Meal_Plan_Job::example_day_meals();
    ...
    function generate_mealplan_day_callback($data)
    {
        ...
        if (empty($meal_plan_day)) {
            return wp_send_json([
                'success' => false,
                'message' => sprintf('%s Meal plan is currently being generated. Typically, it takes around 10 minutes to prepare a plan. Thank you for your patience.', $day_name)
            ], 200);
        }
