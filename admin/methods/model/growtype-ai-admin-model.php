...
class Growtype_Ai_Admin_Model
{
    ...
    public function items_tab_init()
    {
        $hook = add_submenu_page(
            'edit.php?post_type=' . Growtype_Ai_Admin::POST_TYPE,
            __('Models', 'growtype-ai'),
            __('Models', 'growtype-ai'),
            'manage_options',
            Growtype_Ai_Admin::PAGE_NAME,
    ...
    public function screen_option()
    {
        ...
        require_once GROWTYPE_AI_PATH . 'admin/methods/model/table/growtype-ai-admin-model-list-table.php';
    ...
    {
        require_once GROWTYPE_AI_PATH . 'admin/methods/model/table/growtype-ai-admin-model-list-table-record.php';
